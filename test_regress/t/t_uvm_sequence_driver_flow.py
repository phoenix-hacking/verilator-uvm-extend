...
# Require one exact sentinel so partial or duplicate success is not accepted.
test.file_grep_count(test.run_log_filename, r'^\*\* UVM SEQUENCE DRIVER FLOW PASSED \*\*$', 1)
test.passes()
